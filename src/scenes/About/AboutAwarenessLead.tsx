...
interface AboutAwarenessLeadProps {
}

const AboutAwarenessLead: React.FC<AboutAwarenessLeadProps> = (props: AboutAwarenessLeadProps) => {
...
export default AboutAwarenessLead